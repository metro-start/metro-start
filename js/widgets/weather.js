...
import {Util, Storage} from '../utils/utils';
...
export default class Weather {
    ...
    constructor() {
        ...
        this.data = Storage.get('weather', DefaultWeather);
    ...
    /**
     * Updates the current weather value.
     *
